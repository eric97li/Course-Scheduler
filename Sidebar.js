...
class Sidebar extends React.Component {
  ...
  setCourses() {
    if(this.subject.current != null && this.minimumCredits.current != null && this.maximumCredits.current != null) {
      this.props.setCourses(this.searchAndFilter.searchAndFilter(this.props.courses, this.keyword.current.value, this.search.current.value, this.subject.current.value, this.minimumCredits.current.value, this.maximumCredits.current.value));
    }
  }
  ...
  onChange() {
    let word = this.keyword.current.value
    return this.props.keyWordCallBack(word)
  }
          ...
          <Card.Body>
            ...
            <Form.Group controlId="formKeywords" onChange={() => this.setCourses()} style={{width: '100%'}}>
              ...
              <Form.Group controlId="formInterestArea">
                ...
                <Form.Control as="select" ref={this.keyword} onClick={() => this.setCourses()} onChange={this.onChange}>
